...
# Show the location of the barn owl
...
query_xc(X = barn_owl_call, path="tawny_song")
...
summary(bird_pca)
# PC1 explains 21.48% of the variation, PC2 explains 10.56%
# Cumulative 1 and 2 is 32.04%
